        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="sidebar-menu lg:hidden" id="sidebarMenu">
                <nav class="py-4 border-t border-gray-700 space-y-1">
                    <a href="index.php?controller=Admin&action=dashboard" class="block px-4 py-3 text-white hover:bg-gray-800 hover:text-blue-400 rounded transition-colors font-medium">
                        <span class="inline-block mr-2">📊</span> Dashboard
                    </a>
                    <a href="index.php?controller=Admin&action=reports" class="block px-4 py-3 text-white hover:bg-gray-800 hover:text-blue-400 rounded transition-colors font-medium">
                        <span class="inline-block mr-2">📈</span> Reports
                    </a>
