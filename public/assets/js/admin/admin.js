...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-view-member', function() {
        ...
        if (!userId) {
            alert('User ID not found. Make sure table rows have data-user-id attribute.');
            return;
        }
                        ...
                        <div class="bg-gray-800 rounded-lg p-4 mb-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-white font-semibold">${member.user_id}</p>
                                </div>
                                <div>
                                    <p class="text-gray-400 text-sm mb-1">Role</p>
                                    <span class="px-2 py-1 ${member.role === 'admin' ? 'bg-red-600' : member.role === 'trainer' ? 'bg-purple-600' : 'bg-blue-600'} text-white text-xs font-bold rounded">${member.role || 'user'}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-800 rounded-lg p-4 mb-4">
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <p class="text-white font-semibold">${member.first_name}</p>
                                </div>
                                <div>
                                    <p class="text-gray-400 text-sm">Middle Name</p>
                                    <p class="text-white font-semibold">${member.middle_name || 'N/A'}</p>
                                </div>
                                <div>
                                    <p class="text-gray-400 text-sm">Last Name</p>
                                    <p class="text-white font-semibold">${member.last_name}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="text-white font-semibold">${member.created_at}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-800 rounded-lg p-4">
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <p class="text-white font-semibold">${member.plan_name || 'No Active Plan'}</p>
                                </div>
                                <div>
                                    <p class="text-gray-400 text-sm">Status</p>
                                    <span class="status-badge ${member.status === 'active' ? 'status-active' : 'status-inactive'}">${member.status || 'inactive'}</span>
                                </div>
                            </div>
                        </div>
                    `;
